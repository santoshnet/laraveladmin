                  ...
                  <div class="card">
                   ...
                   <div class="row">
                   	   <div class=" col-sm-12 card">
			                    ...
			                    <div class="card-body">
			                      ...
			                      <select data-placeholder="Your Favorite Football Team" multiple class="form-control standardSelect" tabindex="5">
			                        <option value="" label="default"></option>
                   ...
                   <div class="row">
                        ...
                        <div class="card-body">
                          ...
                          <select data-placeholder="Choose a country..." multiple class="form-control standardSelect">
                            <option value="" label="default"></option>
                            <option value="United States">United States</option>
                            <option value="United Kingdom">United Kingdom</option>
                            <option value="Afghanistan">Afghanistan</option>
